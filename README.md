...
**Multi-forge** is designed, not built: the `Forge` trait is the seam, and the
whole orchestrator now runs through it (ADR-0027); GitHub is the first full impl,
GitLab/Gitea are additive (ADR-0026 §6).
