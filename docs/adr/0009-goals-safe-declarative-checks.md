...
is written**. An `observability` goal is reported and never blocks. `bolt-cosmatic goals`
evaluates and prints every outcome without writing (a CI gate surface); `bolt-cosmatic
